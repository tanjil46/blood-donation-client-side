...
{
  user?<li className="hover:border-b-2 hover:border-yellow-500" >DONATION REQUEST</li>:''
}
  

  <li className="hover:border-b-2 hover:border-yellow-500">BLOG</li>
  {
    user?<Link className="hover:border-b-2 hover:border-yellow-500" to='/resistration'>RESISTRATION</Link>:''
  }
